...
pub fn build_router(state: AppState) -> Router {
    ...
    let public_routes = Router::new()
        ...
        .route("/mcp/stream", axum::routing::post(crate::mcp_transport::mcp_post))
        .route("/mcp/stream", axum::routing::get(crate::mcp_transport::mcp_sse))
        .route("/mcp/stream", axum::routing::delete(crate::mcp_transport::mcp_delete))
