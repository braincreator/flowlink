...
export default function Dashboard() {
    ...
    return (_jsxs("div", { className: "space-y-6 fade-in", children: [error && !agents && !shieldStats && (_jsxs("div", { className: "flex flex-col items-center py-16 text-center", children: [_jsx(AlertTriangle, { size: 40, className: "mb-4 text-[var(--color-dim)] opacity-40" }), _jsx("h3", { className: "text-lg font-semibold text-[var(--color-dim)]", children: t('common.unable_connect') }), _jsx("p", { className: "mt-2 text-sm text-[var(--color-dim)] opacity-70", children: error }), _jsx("button", { onClick: () => { refreshAgents(); refreshShield(); refreshAlerts(); }, className: "mt-4 rounded-xl bg-[var(--color-accent)] px-4 py-2 text-sm text-white hover:bg-[var(--color-accent-light)]", children: t('common.retry') })] })), _jsx(DashboardWidgets, { widgets: widgets })] }));
}
