...
export const mockAgents: Agent[] = hostnames.map((h, i) => ({
...
export const mockAlerts: ShieldAlert[] = [
...
export const mockSessions: Session[] = Array.from({ length: 8 }, (_, i) => ({
...
export const mockBackups: Backup[] = Array.from({ length: 12 }, (_, i) => ({
...
export const mockCanaries: CanaryToken[] = [
